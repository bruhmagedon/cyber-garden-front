...
export function MetricCircle({ value, label, sublabel, theme = "default", index = 0 }: MetricCircleProps) {
  ...
  return (
    <motion.div
      ref={ref}
      className="flex flex-col items-center gap-3 p-4 rounded-xl bg-card border shadow-sm"
    ...
    >
      ...
      <div className="flex flex-col items-center gap-1 text-center">
        ...
        {sublabel && (
           <p className="text-muted-foreground text-xs max-w-[150px]">
             {sublabel}
           </p>
        )}
      </div>
