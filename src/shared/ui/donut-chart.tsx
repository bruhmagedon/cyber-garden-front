...
interface DonutChartProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  /** Label of the segment to highlight programmatically */
...
const DonutChart = React.forwardRef<HTMLDivElement, DonutChartProps>(
  (
    ...
    // Resolve which segment is effectively "active"
    const effectiveActiveSegment = React.useMemo(() => {
        if (activeSegmentLabel) {
            return data.find(d => d.label === activeSegmentLabel) || null;
        }
        return internalHoveredSegment;
    }, [activeSegmentLabel, internalHoveredSegment, data]);
        ...
        >
          ...
          <AnimatePresence>
            {data.map((segment, index) => {
              ...
              const isActive = effectiveActiveSegment?.label === segment.label;
              ...
              return (
                <motion.circle
                  ...
                  style={{
                    ...
                    opacity: (effectiveActiveSegment && !isActive) ? 0.5 : 1, // Dim others
